    ...
    <div className='container'>
        ...
        <div className='about-me' id='about-me'>
            ...
            <div className='right-contents'>
                ...
                <br></br>今後はこの経験を活かした技術者として、業界でユニークな存在を目指しております。
        ...
        <div id='portfolio'>
            ...
            <div className='project'>
                <div className='left-contents'>
                    ...
                    <a href='https://seeds-surfers.seeds-surf.com' className='site-jump'>https://seeds-surfers.seeds-surf.com</a>
                    <br></br>
            ...
            <div className='project'>
                <div className='left-contents'>
                    <h3>PROJECT 2</h3>
                    <h2>LP 製作</h2>
                    <p>私自身の現職の個人事業の、植物専門輸入事業「Seeds Surf」の宣伝LPを製作し運用しております。具体的なコストがすぐに
